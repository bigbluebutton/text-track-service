...
module WM
    ...
    class SpeechmaticsWorker_1
      ...
      def perform(data, id)
             ...
             jobID = SpeechToText::SpeechmaticsS2T.create_job("#{data["published_file_path"]}/#{data["recordID"]}",data["recordID"],"mp3",data["userID"],data["auth_key"],data["language_code"],"#{data["published_file_path"]}/#{data["recordID"]}/jobID_#{data["userID"]}.json")
