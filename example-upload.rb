...
request = RestClient::Request.new(
    method: :post,
    url: "http://localhost:4000/tts/uploadvtt/#{meeting_id}",
    payload: { :file => File.open('/Users/rahulrodrigues/Desktop/harddrive/D/innovation/text-track-service/storage/6e35e3b2778883f5db637d7a5dba0a427f692e91-1572466783461/6e35e3b2778883f5db637d7a5dba0a427f692e91-1572466783461-1581344610378-track.vtt', 'rb'),
