...
module TTS
  class PlaybackWorker # rubocop:disable Style/Documentation
    ...
    def perform(params_json, temp_track_vtt, temp_track_json, inbox_dir) # rubocop:disable Metrics/AbcSize
      ...
      playback_redis = Redis::Namespace.new(playback_list_namespace, redis: Redis.new)
